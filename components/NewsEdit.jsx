...
const NewsEdit = () => {
  ...
  const checkValidation = () => {
    ...
    comparePreviousValuesWithCurrent = () => {
      return (
        myArticle.columnOneImage === newsItem.columnOneImage &&
        myArticle.columnOneHeadline === newsItem.columnOneHeadline &&
        myArticle.columnOneText === newsItem.columnOneText &&
        myArticle.columnTwoImage === newsItem.columnTwoImage &&
        myArticle.columnTwoHeadline === newsItem.columnTwoHeadline &&
        myArticle.columnTwoText === newsItem.columnTwoText &&
        myArticle.columnThreeImage === newsItem.columnThreeImage &&
        myArticle.columnThreeHeadline === newsItem.columnThreeHeadline &&
        myArticle.columnThreeText === newsItem.columnThreeText &&
        myArticle.priorityNumber === newsItem.priorityNumber &&
        myArticle.paperDate === newsItem.paperDate
      );
    };
    ...
    const data = [
      {
        ...
        col_1_text:
          'Example Text is here for the first column. This will be the main content of this column.',
        col_img_2: 'col_2_img.jpg',
        col_head_2: 'Header for Column Two',
        col_2_text:
          'Example Text is here for the second column. This will be the main content of this column.',
        col_img_3: 'col_3_img.jpg',
        col_head_3: 'Header for Column Three',
        col_3_text:
          'Example Text is here for the third column. This will be the main content of this column.',
        date: '2023-12-31',
      },
      {
        id: '002',
        ...
        col_1_text:
          'Another Example Text is here for the first column. This will be the main content of this column.',
        col_img_2: 'Another_col_2_img.jpg',
        col_head_2: 'Another Header for Column Two',
        col_2_text:
          'Another Example Text is here for the second column. This will be the main content of this column.',
        col_img_3: 'Another_col_3_img.jpg',
        col_head_3: 'Another Header for Column Three',
        col_3_text:
          'Another Example Text is here for the third column. This will be the main content of this column.',
        date: '2024-01-11',
      },
    ];
    const articleById = data.find(article => article['id'] === id);
    // Update the state for non-file input values
    setNewsItem({
      columnOneImage: articleById.col_img_1,
      columnOneHeadline: articleById.col_head_1,
      columnOneText: articleById.col_1_text,
      columnTwoImage: articleById.col_img_2,
      columnTwoHeadline: articleById.col_head_2,
      columnTwoText: articleById.col_2_text,
      columnThreeImage: articleById.col_img_3,
      columnThreeHeadline: articleById.col_head_3,
      columnThreeText: articleById.col_3_text,
      priorityNumber: articleById.priority,
      paperDate: articleById.date,
    });
    setMyArticle({
      columnOneImage: articleById.col_img_1,
      columnOneHeadline: articleById.col_head_1,
  ...
  return (
    <div className='create-character-container'>
      <div>
        <h1 className='header-text mb-0'>Edit News Article:</h1>
      </div>
      <div className='create-character-form' style={{ marginTop: '5px' }} onClick={() => exitFullScreen()}>

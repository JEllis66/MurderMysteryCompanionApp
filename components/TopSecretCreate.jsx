...
const TopSecretCreate = () => {
  ...
  const checkValidation = () => {
    if (
      ...
      !secretContent || secretContent === null || secretContent === undefined
    ) {
  ...
  useEffect(() => {
    checkValidation();
  }, [secretTitle, secretDescription, secretContent, itemExists]);

  useEffect(() => {
    const isTaken = itemTitleArray.includes(secretTitle);
    setItemExists(isTaken);
  }, [secretTitle]);
  ...
  return (
    <div className='create-character-container'>
      <h1 className='header-text'>Create Secret Item:</h1>
      <div className='create-character-form' style={{ marginTop: '0px' }} onClick={() => exitFullScreen()}>
        <form onSubmit={handleSubmit}>
          <div className='form-group'>
            ...
            {touchedFields.secretTitle && itemExists && (
              <div>
                <p className='form-error-message'>*Title is already taken!</p>
              </div>
            )}
          </div>
          ...
          <div className='text-start' style={{ marginTop: '-5px' }}>
            <label htmlFor='secretContent' className='create-edit-label'>
              Image
            </label>
            <input
              type='file'
...
export default TopSecretCreate;
